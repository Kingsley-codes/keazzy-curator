    ...
    <>
      ...
      <header className="fixed top-0 w-full z-50 bg-[#faf8ff]/90 backdrop-blur-md hidden md:block">
        <div className="flex justify-between items-center w-full px-8 py-6 max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-6">
            <button aria-label="Search" className="text-slate-900 hover:opacity-70 transition-opacity">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" />
              </svg>
            </button>
            <button aria-label="Account" className="text-slate-900 hover:opacity-70 transition-opacity">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <header className="fixed top-0 w-full z-50 bg-slate-100/50 backdrop-blur-md md:hidden">
        <div className="flex items-center justify-between px-6 h-16 w-full max-w-screen-xl mx-auto">
          <button className="p-2 -ml-2 hover:bg-slate-200/50 transition-all rounded-full" aria-label="Menu">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="fixed top-16 w-full z-40 md:hidden bg-[#faf8ff]/95 backdrop-blur-sm">
        <nav className="flex overflow-x-auto px-6 gap-8 mb-0 py-3 border-y border-slate-200/40"
